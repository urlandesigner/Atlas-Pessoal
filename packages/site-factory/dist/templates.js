export const SITE_FACTORY_TEMPLATES = [
    {
        id: "institutional",
        label: "Institucional",
...
export const SITE_FACTORY_TEMPLATE_MAP = Object.fromEntries(SITE_FACTORY_TEMPLATES.map((template) => [template.id, template]));
export function getSiteFactoryTemplate(templateId) {
