...
function bulletList(items: string[], fallback = "- A definir") {
...
function contactLines(briefing: SiteFactoryBriefing) {
...
function generateClaudeFile(briefing: SiteFactoryBriefing) {
...
function generateProjectContextFile(briefing: SiteFactoryBriefing) {
...
function generateSiteStructureFile(briefing: SiteFactoryBriefing) {
  const template = getSiteFactoryTemplate(briefing.templateId)
...
function generateCreativeDirectionFile(briefing: SiteFactoryBriefing) {
  const template = getSiteFactoryTemplate(briefing.templateId)
...
function generateDesignSystemFile(briefing: SiteFactoryBriefing) {
...
function generateCopywritingFile(briefing: SiteFactoryBriefing) {
  return `# Copywriting
...
function generateTasksFile(briefing: SiteFactoryBriefing) {
  const template = getSiteFactoryTemplate(briefing.templateId)
  return `# Tasks
...
export function generateProjectFiles(briefing: SiteFactoryBriefing): SiteFactoryGeneratedFile[] {
  return [
...
export function generateSiteProject(
  input: Partial<SiteFactoryBriefing>
): SiteFactoryProjectResult {
